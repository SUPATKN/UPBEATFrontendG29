...
const Hexagon = ({ map, allPlayer, Me }) => {
  ...
  const handleCellHover = (e, deposit) => {
    if (deposit >= 1) {
      alert("Deposit : " + deposit); // โชว์เงินในเซลล์นั้น
    }
  };

  return (
    <div
      className="hexagon-map-container1"
      style={{
        width: "765px",
        height: "490px",
        marginTop: "14px",
            ...
            <div key={rowIndex} className="hexagon-row">
              {row.map((hex, colIndex) => {
                ...
                if (map.length % 2 === 0 && map[1].length % 2 === 0) {
                  //case1
                  lastRowHexagon1I0 =
                    rowIndex === Math.floor(map.length / 2) - 1 &&
                    colIndex % 2 === 0
                      ? " hexagon1I0"
                      : "";
                  lastRowHexagon1I1 =
                  ...
                  startcowHexagon3 =
                    colIndex === Math.floor(map[1].length / 2)
                      ? " hexagon3I"
                      : "";
                  ...
                  startcowHexagon3 =
                    colIndex === Math.floor(map[1].length / 2) + 1 &&
                  ...
                  //case3
                  lastRowHexagon1I0 =
                    rowIndex === Math.floor(map.length / 2) &&
                    colIndex % 2 === 0
                      ? " hexagon1I0"
                      : "";
                  lastRowHexagon1I1 =
                ...
                return (
                  <div
                    ...
                    onClick={(e) => handleCellHover(e, hex.deposit.currentdep)}
                  >
                    <div className="image-container">
                      {hex.whoBelongName === Me &&
                        hex.deposit.currentdep >= 1 &&
                        hex.deposit.currentdep < 1000 &&
                        !hex.cityCenter &&
                        !treeImg && (
                          <img
                            src={City1}
