...
const Hexagon = ({ map, allPlayer }) => {
  ...
  const [Imgt, setiMgT] = useState(21);
  ...
  return (
    <div style={{width: "900px", height: "450px",marginRight:"100px",marginTop:"50px", border: "2px solid black", overflow: "hidden", background: "#ffffff" }}>
    ...
    >
      <div className="main-map" style={{ width: "100%", height: "100%" ,paddingLeft:"50px"}}>
        {map.map((row, rowIndex) => (
          <div key={rowIndex} className="hexagon-row">
            {row.map((hex, colIndex) => {
              ...
              const lastRowHexagon1I0 = (rowIndex === 7  && colIndex %2 === 0 )? " hexagon1I0" : "";
              const lastRowHexagon1I1 = (rowIndex === 7  && colIndex %2 !== 0 )? " hexagon1I1" : "";
              ...
              return (
                ...
                className={
                  (rowIndex < map.length / 2 && colIndex < row.length / 2
                    ...
                    : rowIndex >= map.length / 2 && colIndex < row.length / 2
                    ? "hexagon2"
                    : "hexagon3")  + lastRowHexagon1I0 + lastRowHexagon1I1 + startcowHexagon3
                }
                style={{
                  marginLeft: `${mgL}px`,
                  marginBottom: `${mgB}px`,
